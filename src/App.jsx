          ...
          <div className="flex flex-col md:flex-row gap-8 lg:gap-12 items-stretch">
            <div className="w-full md:w-[35%] pt-4 text-left flex flex-col">
              ...
              <ul className="experiences-list leading-snug flex-grow">
                ...
                <li>
                  <img src="https://d112y698adiu2z.cloudfront.net/photos/production/challenge_thumbnails/003/772/223/datas/original.png" alt="Hack the Valley" className="experience-logo" style={{ filter: 'none', width: 36, height: 36 }} />
                  <span>Web Developer @ <a href="https://hackthevalley.io/" target="_blank" rel="noopener noreferrer" className="experience-link cursor-pointer hover:opacity-80">Hack the Valley</a></span>
                </li>
                <li>
